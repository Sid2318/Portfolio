...
// No hooks required — this component only displays contact info

export default function Contact() {
  // Contact form removed (right section). Contact info and social links displayed only.
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 text-lg sm:text-xl font-normal leading-relaxed">
                ...
                to hear from you. Whether you have a question or just want to
            ...
            <div className="pt-4">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-gray-800/30 border border-gray-700/40 flex items-center justify-center text-gray-300 hover:text-white hover:bg-gray-700/50 hover:border-gray-600/50 hover:scale-110 transition-all duration-300"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-lg bg-gray-800/30 border border-gray-700/40 flex items-center justify-center text-blue-500 hover:text-blue-400 hover:bg-gray-700/50 hover:border-gray-600/50 hover:scale-110 transition-all duration-300"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
